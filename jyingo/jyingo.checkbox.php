 ...
 */ 
 ...
 class jyingo_checkbox extends jyingo_control {
 	
     public $active_tag = 'php:checkbox';
     public $text_default = '';
     ...
     function __construct($params)
     {
       ...
       $this->set_client_instance('jyingo.checkbox');
       
     	 $this->client_vars(array(
     	  "text", "checked"
     	 )); 
      
       $this->add_class('jyingo_checkbox');
     ...
     function render()
     {
     	 echo '<div '.$this->get_property_string(' ').'>';
       echo '<input type="checkbox" name="'.$this->get_instance().'" id="'.$this->get_instance().'" '.($this->checked ? 'checked="checked"' : '').'" />';
